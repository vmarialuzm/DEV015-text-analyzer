...
let li_metricas_caracteres = document.querySelector(".metricas.caracteres")
let li_metricas_sin_espacios = document.querySelector(".metricas.sin.espacios")
let li_metricas_palabras = document.querySelector(".metricas.palabras")
let li_metricas_numeros = document.querySelector(".metricas.numeros")
let li_metricas_sum_numeros = document.querySelector(".metricas.sum.numeros")
let li_metricas_promedio = document.querySelector(".metricas.promedio")
